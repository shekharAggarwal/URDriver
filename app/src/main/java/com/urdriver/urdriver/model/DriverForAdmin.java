...
public class DriverForAdmin {
    ...
    String DriverName, DriverPhone, DriverCabModel, DriverCabBrand, DriverCabNumber, sourceAddress,
            destinationAddress, StartTrip, BookAccount, TotalTrip, Name, Email;

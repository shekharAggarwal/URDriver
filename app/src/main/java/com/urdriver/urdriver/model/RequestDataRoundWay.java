...
public class RequestDataRoundWay {
    private String Id;
    ...
    public RequestDataRoundWay() {
    }

    public RequestDataRoundWay(String id, String fullName, String phoneNumber, String email, String sourceAddress, String destinationAddress, String pickupDate, String dropDate, String pickupTime, String source, String destination, String cabs, String bookAccount, String cabFare, String cabDriver, String cabStatus, String cabModel, String cabTnxId) {
        Id = id;
